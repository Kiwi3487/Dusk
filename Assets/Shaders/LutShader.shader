...
{
    //This script is identical to the shader provided in classbut it basically uses Look-Up Table color grading effect to a texture, mixing the original image with a color-graded version based on the LUT provided.
    Properties
    {
